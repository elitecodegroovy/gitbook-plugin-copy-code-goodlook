require(["gitbook", "jQuery"], function(gitbook, $) {
  ...
  gitbook.events.bind("page.change", function() {
    $("pre").each(function(){
      ...
      $copyCodeButton.css({"position": "absolute", "top": "5px", "right": "5px", "padding": "3px", "background-color":"#ffffff", "color":"#171616", "border-radius": "5px" , "-moz-border-radius": "5px", "-webkit-border-radius": "5px", "border": "2px solid #CCCCCC"});
      $copyCodeButton.click(function(){
        ...
        if($codeContainer) {
          ...
          if(copyToClipboard(selectedText) == true){
            buttonNewText = "Copied to clipboard";
            selectElementText($codeContainer.get(0));
          } else {
